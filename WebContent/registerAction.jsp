				...
				<div class="headercontent">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="fleft">
									<h1>Welcome to TutorMe, <%=request.getAttribute("firstName")%>!</h1>
								</div>
				...
				<div class="col-md-12">
					<form name="registerForm" action="register" method="post">
						...
						<div class="wrapcontent">
							<p>The registration is success, you'll be able to sign in to TutorMe with the email address: <b><i>${email}</i></b></p>
