			...
			$.each($t.p.colModel,function(ci){
				...
				if(this.search){
					...
					case "text":
						...
						$("td:eq(1)",stbl).append("<input type='text' class='text edd-input' style='width:100%;padding:0px;border-color:#00CCFF;' name='"+(cm.index || cm.name)+"' id='gs_"+cm.name+"' value='"+df+"'/>");
						$(thd).append(stbl);
