				...
				<div class="headercontent">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="fleft">
									<h1>Invalid Request! Your Account was Activated before!</h1>
								</div>
			...
			<div class="container padtop40 padbot50">
				...
				<div class="col-md-12">
					<div class="wrapcontent text-center">
						<p>Invalid Request! Your Account was Activated before!</p>
						<p>Click <a href="/">here</a> to go back home-page.</p>
					</div>
				</div>				
				<!-- MAIN CONTENT ENDS -->
